...
<body>
	...
	<div class="container">
		...
		<p id="info">Bienvenue sur le site Kravmagapérigueux.org, pour en voir plus, inscrivez-vous. Sinon, <a href="connection.php">Connectez-vous.</a></p>
	 	...
	 	<div id="form">
			<form method="POST" action="index.php">
				<table>
					<tr>
						<td>Pseudo</td>
						<td><input type="text" name="pseudo" placeholder="Ex : serge" required></td>
					</tr>
					<tr>
						<td>Email</td>
